...
class Audio:
    ...
    def record(self, save_path):
        ...
        if self.recording:
            ...
            self.proc = subprocess.Popen(
                # shlex.split('ffmpeg -f dshow -y -rtbufsize 100M -framerate 30 -probesize 10M -i video="JOYTRON HD20" -c:v libx264 -r 30 -preset ultrafast -tune zerolatency -crf 25 -pix_fmt yuv420p ' + save_path +'/' + 'webcam.mp4'),
                shlex.split('ffmpeg -f dshow -i audio="virtual-audio-capturer" -r 30 ' + save_path + '/' + 'audio.mp3'),
    ...
    def save_data(self, save_path):
        ...
        df.to_csv(save_path + "/audio_timetable.csv", index=False)
