...
class FirstPageWidget(QWidget):
    ...
    def init_ui(self):
        ...
        game_label = QLabel('Video number', self)
        game_label.setAlignment(Qt.AlignVCenter)

        self.game_cb = QComboBox(self)
        # self.game_cb.addItem('Baseline')
        self.game_cb.addItem('video1')
        self.game_cb.addItem('video2')
        self.game_cb.addItem('video3')
        self.game_cb.addItem('video4')
    ...
    def show_popup(self):
        reply = QMessageBox.question(
            ...
            f'Video number: {self.game_cb.currentText()}\n'
